...
// Inisialisasi dengan nilai default string kosong.
$status_message = ''; // FIX: Diinisialisasi sebagai string kosong
$error_messages = [];
...
// Fungsi untuk memvalidasi format tanggal DD-MM-YYYY menggunakan Regular
// Expression.
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($error_messages)) {
        ...
        // FIX: Redirect untuk mencegah form resubmission saat refresh (Post/Redirect/Get pattern)
        // Header ini akan mengarahkan ulang pengguna ke halaman yang sama.
...
<input type="text" id="tanggal_lahir" name="tanggal_lahir" value="<?php echo isset($tanggal_lahir) ? htmlspecialchars($tanggal_lahir) : ''; ?>" required>
</div>
